    ...
    public class StartupManager
    {
            ...
            if (IsAdministrator())
            {
                ...
                if (scheduler != null)
                {
                    try
                    {
                        ...
                        ITaskFolder folder = scheduler.GetFolder("\\KQDataManage");
            ...
            if (scheduler == null)
            {
                try
                {
                      ...
                      Registry.CurrentUser.OpenSubKey(REGISTRY_RUN))
                    {
                        ...
                        if (key != null)
                        {
                            string value = (string)key.GetValue("KQData");
                            if (value != null)
        ...
        private void CreateSchedulerTask()
        {
            ...
            definition.RegistrationInfo.Description =
              "This task starts the KQDataManage on Windows startup.";
            ...
            try
            {
                folder = root.GetFolder("KQDataManage");
            }
            catch (IOException)
            {
                folder = root.CreateFolder("KQDataManage", "");
            }
        ...
        private void DeleteSchedulerTask()
        {
            ...
            try
            {
                ITaskFolder folder = root.GetFolder("KQDataManage");
                folder.DeleteTask("Startup", 0);
            }
            catch (IOException) { }
            try
            {
                root.DeleteFolder("KQDataManage", 0);
            }
            catch (IOException) { }
        }
        ...
        private void CreateRegistryRun()
        {
            ...
            key.SetValue("KQData", Application.ExecutablePath);
        }

        private void DeleteRegistryRun()
        {
            RegistryKey key = Registry.CurrentUser.CreateSubKey(REGISTRY_RUN);
            key.DeleteValue("KQData");
        }
